...
export const arrayInnerNavBar_PDCTR: InnerNavBar_InnerData = [
  ...
  { INNER_NAV_BAR_KEY: "otherProviders", INNER_NAV_BAR_VALUE: "other providers" },
...
export const arraySectionToRender_PDCTR: ArraySectionToRender_Type = [
  {
    ...
    component: null,
    toNavbar: {
      id: arrayInnerNavBar_PDCTR[0][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
    },
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PDCTR[1][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
    },
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PDCTR[2][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
      jsx: arrayInnerNavBar_PDCTR[2][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_VALUE],
    },
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PDCTR[3][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
    },
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PDCTR[4][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
      jsx: arrayInnerNavBar_PDCTR[4][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_VALUE],
    },
  },
]
