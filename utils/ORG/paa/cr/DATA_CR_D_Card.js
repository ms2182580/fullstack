...
export const DATA_CR_D_CardRight = [
  {
    [DATA_ORG_KeyNamesForCards_D.HIGHLIGHT]: {
      ...
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["Free Consultation", "Disability Law"],
    },
    areasOfLaw: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Areas of Law",
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["Education", " Divorce", "Personal Injury"],
    },
    jurisdiction: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "jurisdiction",
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["NY", "NJ", "CT", "MD", "FL"],
    },
    professionalExperience: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Professional Experience",
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["The Truong-MacGill Law Firm, since 2010"],
    },
    languagesSpoken: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Languages Spoken",
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["English", "Cantonese", "Manda"],
    },
    ...
    [DATA_ORG_KeyNamesForCards_D.THIRD_PAGE_DATA]: {
      ...
      [DATA_ORG_KeyNamesForCards_D.CARD]: {
        [DATA_ORG_KeyNamesForCards_D.WITH_BACKGROUND]: {
          ...
          [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["Civil Rights", "Disability Rights", "Public Accomodations"],
        },
        ...
        [DATA_ORG_KeyNamesForCards_D.LEFT]: {
          ...
          payment: {
            ...
            [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["Major credit cards accepted"],
          },
          cost: {
        ...
        [DATA_ORG_KeyNamesForCards_D.RIGHT]: {
          ...
          education: {
            ...
            [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["Brooklyn Law School, J.D., 2010", "Northwestern University, B.A., 2005"],
            [DATA_ORG_KeyNamesForCards_D.DISPLAY_BLOCK]: true,
          },
          languagesSpoken: {
            [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Languages Spoken",
            [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["English", "Cantonese", "Mandarin"],
          },
          jurisdictionsAdmittedToPractice: {
            [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Jurisdictions Admitted to Practice",
            [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["New York, since 2010", "New Jersey, since 2010", "Connecticut, since 2013", "Florida, since 2018"],
            [DATA_ORG_KeyNamesForCards_D.DISPLAY_BLOCK]: true,
          },
          professionalAssociations: {
            [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Professional Associations",
  ...
  },
  {
    [DATA_ORG_KeyNamesForCards_D.HIGHLIGHT]: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: [DATA_ORG_KeyNamesForCards_D.HIGHLIGHT],
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["Free Consultation", "Video Conferencing"],
    },
    areasOfLaw: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Areas of Law",
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["Civil Rights", "Education", "Personal Injury"],
    },
    jurisdiction: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "jurisdiction",
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["NY", "NJ", "CT"],
    },
    professionalExperience: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Professional Experience",
      [DATA_ORG_KeyNamesForCards_D.VALUE_NAME]: ["Abrahams Law since 2001"],
    },
    languagesSpoken: {
      [DATA_ORG_KeyNamesForCards_D.KEY_NAME]: "Languages Spoken",
