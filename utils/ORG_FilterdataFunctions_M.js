import { ORG_FILTERS_DATA_M } from "./ORG_FiltersCategories"
...
export const ORG_Filterdata_Diagnosis = (whichSelect = []) => {
  ...
  return pickMoreThanOne(ORG_FILTERS_DATA_M.diagnosis)
}
...
export const ORG_Filterdata_AgesServed = (whichSelect = []) => {
  ...
  return pickMoreThanOne(ORG_FILTERS_DATA_M.agesServed)
}
...
export const ORG_Filterdata_Languages = (whichSelect = []) => {
  ...
  return pickMoreThanOne(ORG_FILTERS_DATA_M.languages, true)
}
...
export const ORG_Filterdata_YoP = (whichSelect = []) => {
  ...
  return pickJustOne(ORG_FILTERS_DATA_M.yearsOfPractice)
}
...
export const ORG_Filterdata_ServiceSetting = (whichSelect = []) => {
  ...
  return pickMoreThanOne(ORG_FILTERS_DATA_M.serviceSetting)
}
...
export const ORG_Filterdata_Insurance = (whichSelect = []) => {
  ...
  return pickMoreThanOne(ORG_FILTERS_DATA_M.insurance)
}
...
export const ORG_Filterdata_MeetingFormat = (whichSelect = []) => {
  ...
  return pickMoreThanOne(ORG_FILTERS_DATA_M.meetingFormat)
}
...
export const ORG_Filterdata_SessionType = (whichSelect = []) => {
  ...
  return pickMoreThanOne(ORG_FILTERS_DATA_M.sessionType)
}
...
export const ORG_Filterdata_Transportation = (whichSelect = []) => {
  ...
  return pickMoreThanOne(ORG_FILTERS_DATA_M.transportation)
}
...
export const ORG_Filterdata_ProviderType = (whichSelect = []) => {
  ...
  return pickJustOne(ORG_FILTERS_DATA_M.providerType)
}
