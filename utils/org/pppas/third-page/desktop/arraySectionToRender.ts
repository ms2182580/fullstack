...
export const arraySectionToRender_PPAS: ArraySectionToRender_Type = [
  {
    ...
    component: null,
    toNavbar: {
      id: arrayInnerNavBar_PPAS[0][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
    },
  },
  {
    name: null,
    component: null,
    toNavbar: {
      id: arrayInnerNavBar_PPAS[1][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
    },
  },
  {
    ...
    [ArraySection_KEYS.PROPS_COMPONENT]: {
      [ContactUsCustomProperties_KEY.ContactUsCustomProperties_KEY]: {
        ...
        [ContactUsCustomProperties_KEY.DATA]: ["Housing help", "Rent relief", "Funding help", "Intake process", "Interpreter services", "Other"],
      },
  ...
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PPAS[2][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
    },
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PPAS[3][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY],
      jsx: arrayInnerNavBar_PPAS[3][InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_VALUE],
    },
  },
]
