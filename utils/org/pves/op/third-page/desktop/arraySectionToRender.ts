...
import { PVES_General_D_RelatedJobs } from "@/components/org/flow_resources/third-page/pves/general/desktop/PVES_General_D_RelatedJobs"
import {
...
export const arraySectionToRender_PVES: ArraySectionToRender_Type = [
  ...
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PVES[1][
        InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY
      ],
      jsx: arrayInnerNavBar_PVES[1][
        InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_VALUE
      ],
    },
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PVES[2][
        InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY
      ],
      jsx: arrayInnerNavBar_PVES[2][
        InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_VALUE
      ],
    },
  },
  ...
  },
  {
    ...
    toNavbar: {
      id: arrayInnerNavBar_PVES[4][
        InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_KEY
      ],
      jsx: arrayInnerNavBar_PVES[4][
        InnerNavBar_InnerData_KEYS.INNER_NAV_BAR_VALUE
      ],
    },
  },
