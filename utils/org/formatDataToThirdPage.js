...
export const formatDataToThirdPage = (
  dataCard,
  dataCardLeft,
  rightPart,
  fullName,
  specificDataForThisResource
) => {
  let getFilterThirdPageDataOnObject = filterThirdPageDataOnObject(
    rightPart?.thirdPageData
  )
    ...
    card: {
      leftPart: {
        ...
        [SPECIFIC_DATA_KEY.SPECIFIC_DATA_KEY]:
          dataCardLeft?.[SPECIFIC_DATA_KEY.SPECIFIC_DATA_KEY] || "",
      },
      rightPart: rightPart,
    },
    fullName,
    [DATA_ORG_KeyNamesForCards_D_KEYS.OTHER]: {
      [DATA_ORG_KeyNamesForCards_D_KEYS.GET_FILTER_THIRDPAGE_DATAONOBJECT]:
        getFilterThirdPageDataOnObject,
