import { KeywordCitiesWrapper, NavBar_D_DropdownSuggestionComponentWrapper } from "./styles/NavBar_D_DropdownSuggestionComponentWrapper.js"


export const NavBar_D_DropdownSuggestionComponent = ({
  isFocus,
  setIsHover,
  suggestions,
  keywordClickByUser,
  ...
  return (
    <NavBar_D_DropdownSuggestionComponentWrapper
      ref={theRef}
