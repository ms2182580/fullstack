...
export const ST_M_Results_FilterList = () => {
  ...
  */
  ...
  const { mustShowFiltersMobile, setMustShowFiltersMobile } =
    useORG_Ctx_ShowFiltersMobile()
  ...
  const { setShouldFetchMobileWithFilters } =
  ...
  return (
    <>
      <ST_M_Results_FilterListMainWrapper>
        {" "}
        <span onClick={handleShowFiltersMobile} tabIndex={-1}>
