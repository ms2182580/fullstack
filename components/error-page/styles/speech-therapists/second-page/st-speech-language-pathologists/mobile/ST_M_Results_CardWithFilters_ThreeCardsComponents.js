...
import { ST_M_Results_CardWithFilters_Paginator } from "./ST_M_Results_CardWithFilters_Paginator"
import { ST_M_Results_CardWithFilters_ThreeCardsComponentsWrapper } from "./styles/ST_M_Results_CardWithFilters_ThreeCardsComponentsWrapper"

export const ST_M_Results_CardWithFilters_ThreeCardsComponents = ({ ...props }) => {
  ...
  return (
    <ST_M_Results_CardWithFilters_ThreeCardsComponentsWrapper>
      <div className="card-container">
        <BookmarkSaveSTMobileSvg tabIndex={0} />
        <ST_M_Results_CardWithFilters_Paginator
