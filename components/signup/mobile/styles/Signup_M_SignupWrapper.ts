...
export const H4_EMAIL_SIGNUP = styled(H4)<InputEmailType>`
  color: ${(x) =>
...
export const CAPTION_EMAIL_SIGNUP = styled(Caption)<InputEmailType>`
  color: ${(x) =>
    x.displayRedEmail.emailAlreadyRegistered !== "" ||
    (x.displayRedEmail.hasError === true &&
      x.displayRedEmail.hasTouched === true)
...
export const StyleInputFirst = styled.div<InputFirstType>`
  display: flex;
  flex-direction: column;
  position: relative;
...
export const InputEmail = styled.input<InputType>`
  outline: ${(x) =>
...
export const InputPassword = styled.input<InputType>`
  outline: ${(x) =>
