...
import { ORG_D_Results_FilterListMainWrapper } from "../desktop/styles/ORG_D_Results_FilterListMainWrapper"

export const ORG_M_Results_FilterListMain = ({ refUserViewShowFullMapFilter }) => {
  const { secondpageFiltersORG } = useORG_Ctx_D_SecondpageFilters()
  console.log({ secondpageFiltersORG })
  return (
