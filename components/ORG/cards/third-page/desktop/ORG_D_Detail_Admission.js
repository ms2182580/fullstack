...
export const ORG_D_Detail_Admission = () => {
  ...
  return (
    <>
      <ORG_D_Detail_AdmissionWrapper ref={toMoveTheView}>
        <header>
          <H3>Admissions</H3>
        </header>
