import { InnerNavBar_InnerData, InnerNavBar_InnerData_KEYS } from "@/utils/ORG/third-page/InnerNavBar"
...
export const ORG_D_Detail_ContactUs = ({ defaultId = "contactus", arrayInnerNavBar = null, selectTags = null }: Props) => {
