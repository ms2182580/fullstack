...
import { ST_D_CardEmailWrapper } from "./styles/ST_D_CardEmailWrapper.js"

export const ST_D_CardEmail = ({ email, isMobile = false, isThirdPageMobile = false }) => {
  return (
    <ST_D_CardEmailWrapper
