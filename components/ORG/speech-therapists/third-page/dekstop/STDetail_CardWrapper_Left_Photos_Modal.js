...
import { STDetail_CardWrapper_Left_Photos_ModalWrapper } from "./styles/STDetail_CardWrapper_Left_Photos_ModalWrapper.js"

const imagesToShow = [0, 1, 2, 3, 4, 5]

export const STDetail_CardWrapper_Left_Photos_Modal = ({ showModal, handleHideModal, photo, name, lastName }) => {
  ...
  return (
    <STDetail_CardWrapper_Left_Photos_ModalWrapper
      ref={componentRef}
      showModal={showModal}>
