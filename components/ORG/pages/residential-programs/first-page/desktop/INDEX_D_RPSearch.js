...
export const INDEX_D_RPSearch = ({ positionInArray, isSelected = false, componentName }) => {
  ...
  const handleMoveToThirdPage = (e, theData, subCategoryArrPosition, resourceArrPosition, titleSubCategory) => {
    let getDataLeft = DATA_LT_D_CardLeft[resourceArrPosition]
    let getDataRight = DATA_LT_D_CardRight[resourceArrPosition]
    ...
    if (!failed) {
      ...
      let getDetailName = DATA_LT_D_CardRight[resourceArrPosition][DATA_ORG_KeyNamesForCards_D.THIRD_PAGE_DATA][DATA_ORG_KeyNamesForCards_D.FOLDER_NAME]
