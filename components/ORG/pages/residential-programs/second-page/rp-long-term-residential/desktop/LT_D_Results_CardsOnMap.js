...
import { LT_D_Results_CardsOnMapCard } from "./LT_D_Results_CardsOnMapCard.js"
import { LT_D_Results_CardsOnMapWrapper } from "./styles/LT_D_Results_CardsOnMapWrapper.js"

export const LT_D_Results_CardsOnMap = ({ bottomOfButton }) => {
  ...
  return (
    <LT_D_Results_CardsOnMapWrapper
      ref={myRef}
