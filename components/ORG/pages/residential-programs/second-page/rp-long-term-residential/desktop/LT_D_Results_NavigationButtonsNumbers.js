...
import { LT_D_Results_FinalButtonsNumberPage_W } from "./styles/LT_D_Results_FinalButtonWrapper.js"

export const LT_D_Results_NavigationButtonsNumbers = () => {
      ...
      <div>
        {amountOfPagesToClick.map((x, i) => {
          ...
          if (pagination === i + 1) {
            return (
              <Fragment key={i}>
                <LT_D_Results_FinalButtonsNumberPage_W isActive>
                  <P bold> {i + 1}</P>
                </LT_D_Results_FinalButtonsNumberPage_W>
              </Fragment>
            )
          }
