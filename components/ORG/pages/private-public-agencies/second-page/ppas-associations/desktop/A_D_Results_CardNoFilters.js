...
import { A_D_Results_CardWrapper } from "./styles/A_D_Results_CardWrapper.js"

export const A_D_Results_CardNoFilters = () => {
  /* 
    ...
    <>
      {Array(10)
        ...
        .map((x, i) => {
          ...
          return (
            <A_D_Results_CardWrapper key={`${cardData[renderThisCard].reviews}_${i}`}>
              <div className="LEFT-PART">
                ...
                <div>
                  <ORG_D_Results_Cardphone phoneNumber={DATA_A_D_CardLeft[renderThisContact].phone} />

                  <ORG_D_Results_CardEmail email={DATA_A_D_CardLeft[renderThisContact].email} />

                  <ORG_D_Results_CardLocation
                    locationCity={DATA_A_D_CardLeft[renderThisContact].location.city}
                    locationStreetNumber={DATA_A_D_CardLeft[renderThisContact].location.streetNumber}
                    locationStreetName={DATA_A_D_CardLeft[renderThisContact].location.streetName}
                    locationState={DATA_A_D_CardLeft[renderThisContact].location.state}
                    howFar={DATA_A_D_CardLeft[renderThisContact].location.howFar}
                  />
                </div>
              </div>
              ...
              <div className="RIGHT-PART">
                ...
                <Highlights_D highlights={DATA_A_D_CardRight[renderThisContact].highlights} />

                <P
                  primary_hover
                  bold>
                  Area of Focus: <span>{DATA_A_D_CardRight[renderThisContact].areaOfFocus}</span>
                </P>
                <P
                  primary_hover
                  bold>
                  Services Offered: <span>{new Intl.ListFormat("en", { style: "short" }).format(DATA_A_D_CardRight[renderThisContact].servicesOffered)}</span>
                </P>

                <P
                  primary_hover
                  bold>
                  Languages Spoken: <span>{new Intl.ListFormat("en", { style: "short" }).format(DATA_A_D_CardRight[renderThisContact].languagesSpoken)}</span>
                </P>
              </div>
