...
import { A_D_Results_FinalButtonsNumberPage_W } from "./styles/A_D_Results_FinalButtonWrapper.js"

export const A_D_Results_NavigationButtonsNumbers = () => {
      ...
      <div>
        {amountOfPagesToClick.map((x, i) => {
          ...
          if (pagination === i + 1) {
            return (
              <Fragment key={i}>
                <A_D_Results_FinalButtonsNumberPage_W isActive>
                  <P bold> {i + 1}</P>
                </A_D_Results_FinalButtonsNumberPage_W>
              </Fragment>
            )
          }
