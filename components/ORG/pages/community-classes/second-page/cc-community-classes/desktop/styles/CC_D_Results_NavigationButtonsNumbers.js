...
import { CC_D_Results_FinalButtonsNumberPage_W } from "./styles/CC_D_Results_FinalButtonWrapper.js"

export const CC_D_Results_NavigationButtonsNumbers = () => {
      ...
      <div>
        {amountOfPagesToClick.map((x, i) => {
          ...
          if (pagination === i + 1) {
            return (
              <Fragment key={i}>
                <CC_D_Results_FinalButtonsNumberPage_W isActive>
                  <P bold> {i + 1}</P>
                </CC_D_Results_FinalButtonsNumberPage_W>
              </Fragment>
            )
          }
