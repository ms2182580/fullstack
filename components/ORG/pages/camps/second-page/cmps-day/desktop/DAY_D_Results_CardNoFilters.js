...
import { DAY_D_Results_CardWrapper } from "./styles/DAY_D_Results_CardWrapper.js"

export const DAY_D_Results_CardNoFilters = () => {
  /* 
    ...
    <>
      {Array(10)
        ...
        .map((x, i) => {
          ...
          let renderThisContact = i % DATA_DAY_D_CardLeft.length

          return (
            <DAY_D_Results_CardWrapper key={`${cardData[renderThisCard].reviews}_${i}`}>
              <div className="LEFT-PART">
                ...
                <div>
                  <ORG_D_Results_Cardphone phoneNumber={DATA_DAY_D_CardLeft[renderThisContact].phone} />

                  <ORG_D_Results_CardEmail email={DATA_DAY_D_CardLeft[renderThisContact].email} />

                  <ORG_D_Results_CardWebsite
                    firstName={DATA_DAY_D_CardLeft[renderThisContact].web.fistName}
                    lastName={DATA_DAY_D_CardLeft[renderThisContact].web.lastName}
                  />

                  <ORG_D_Results_CardLocation
                    locationCity={DATA_DAY_D_CardLeft[renderThisContact].location.city}
                    locationStreetNumber={DATA_DAY_D_CardLeft[renderThisContact].location.streetNumber}
                    locationStreetName={DATA_DAY_D_CardLeft[renderThisContact].location.streetName}
                    locationState={DATA_DAY_D_CardLeft[renderThisContact].location.state}
                    howFar={DATA_DAY_D_CardLeft[renderThisContact].location.howFar}
                  />
                </div>
              </div>
              ...
              <div className="RIGHT-PART">
                ...
                <Highlights_D highlights={DATA_DAY_D_CardRight[renderThisFilter].highlights} />

                <P
                  primary_hover
                  bold>
                  Program Emphasis: <span>{new Intl.ListFormat("en").format(DATA_DAY_D_CardRight[renderThisFilter].programEmphasis)}</span>
                </P>
                <P
                  primary_hover
                  bold>
                  Price:{" "}
                  <span>{`${DATA_DAY_D_CardRight[renderThisFilter].price.currency}${DATA_DAY_D_CardRight[renderThisFilter].price.ammount}/${DATA_DAY_D_CardRight[renderThisFilter].price.frequency}`}</span>
                </P>
                <P
                  primary_hover
                  bold>
                  Activities: <span>{new Intl.ListFormat("en").format(DATA_DAY_D_CardRight[renderThisFilter].activities)}</span>
                </P>
                <P
                  primary_hover
                  bold>
                  Languages: <span>{new Intl.ListFormat("en").format(DATA_DAY_D_CardRight[renderThisFilter].languages)}</span>
                </P>
              </div>
