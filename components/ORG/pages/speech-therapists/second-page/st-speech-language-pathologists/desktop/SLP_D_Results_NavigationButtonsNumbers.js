...
import { SLP_D_Results_FinalButtonsNumberPage_W } from "./styles/SLP_D_Results_FinalButtonWrapper.js"

export const SLP_D_Results_NavigationButtonsNumbers = () => {
      ...
      <div>
        {amountOfPagesToClick.map((x, i) => {
          ...
          if (pagination === i + 1) {
            return (
              <Fragment key={i}>
                <SLP_D_Results_FinalButtonsNumberPage_W isActive>
                  <P bold> {i + 1}</P>
                </SLP_D_Results_FinalButtonsNumberPage_W>
              </Fragment>
            )
          }
