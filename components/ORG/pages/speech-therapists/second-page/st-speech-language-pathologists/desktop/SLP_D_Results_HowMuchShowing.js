...
import { SLP_D_Results_HowMuchShowingWrapper } from './styles/SLP_D_Results_HowMuchShowingWrapper.js'

export const SLP_D_Results_HowMuchShowing = () => {
  ...
  return (
    <SLP_D_Results_HowMuchShowingWrapper>
      <P semibold>
