...
import { ST_M_Search_SearchComponentWrapper } from "./styles/ST_M_Search_SearchComponentWrapper"

export const ST_M_Search_SearchComponent = () => {
  const router = useRouter()

  const handleRoute = () => {
    router.push(`${router.pathname}/pst/st-speech-language-pathologists`)
  }
