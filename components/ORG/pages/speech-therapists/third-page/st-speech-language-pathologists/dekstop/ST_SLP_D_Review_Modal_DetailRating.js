...
import { ST_SLP_D_Review_Modal_DetailRatingWrapper } from "./styles/ST_SLP_D_Review_Modal_DetailRatingWrapper.js"
...
export const ST_SLP_D_Review_Modal_DetailRating = ({ rating }) => {
  const [formatRating, setFormatRating] = useState(formatRatingFunc(Number(rating)))

  return (
    <ST_SLP_D_Review_Modal_DetailRatingWrapper>
      <div>
