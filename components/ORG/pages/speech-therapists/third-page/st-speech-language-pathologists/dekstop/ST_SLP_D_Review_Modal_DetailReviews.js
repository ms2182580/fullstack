...
import { ST_SLP_D_Review_Modal_DetailReviewsWrapper } from "./styles/ST_SLP_D_Review_Modal_DetailReviewsWrapper.js"

export const ST_SLP_D_Review_Modal_DetailReviews = ({ name, lastName }) => {
  ...
  return (
    <ST_SLP_D_Review_Modal_DetailReviewsWrapper className="STDetail_Review_Modal_DetailReviewsWrapper">
      <div>
    ...
    </ST_SLP_D_Review_Modal_DetailReviewsWrapper>
  )
}
