...
import { ST_SLP_D_Reviews_IndividualComponentWrapper } from './styles/ST_SLP_D_Reviews_IndividualComponentWrapper.js'

export const ST_SLP_D_Reviews_IndividualComponent = ({ rating = 5, review, userName }) => {
  const [month, setMonth] = useState(ORG_ST_Review_Months())

  return (
    <ST_SLP_D_Reviews_IndividualComponentWrapper>
