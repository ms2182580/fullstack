...
import { SES_D_Results_FinalButtonsNumberPage_W } from "./styles/SES_D_Results_FinalButtonWrapper.js"

export const SES_D_Results_NavigationButtonsNumbers = () => {
      ...
      <div>
        {amountOfPagesToClick.map((x, i) => {
          ...
          if (pagination === i + 1) {
            return (
              <Fragment key={i}>
                <SES_D_Results_FinalButtonsNumberPage_W isActive>
                  <P bold> {i + 1}</P>
                </SES_D_Results_FinalButtonsNumberPage_W>
              </Fragment>
            )
          }
