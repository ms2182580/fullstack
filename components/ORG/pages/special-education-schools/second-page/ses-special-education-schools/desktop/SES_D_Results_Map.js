...
import { SES_D_Results_CardsOnMap } from "./SES_D_Results_CardsOnMap.js"
import { SES_D_Results_MapWrapper } from "./styles/SES_D_Results_MapWrapper.js"

export const SES_D_Results_Map = ({ refUserViewShowFullMapButton }) => {
  ...
  return (
    <SES_D_Results_MapWrapper>
      ...
      <SES_D_Results_CardsOnMap bottomOfButton={bottomOfButton} />
    </SES_D_Results_MapWrapper>
  )
}
