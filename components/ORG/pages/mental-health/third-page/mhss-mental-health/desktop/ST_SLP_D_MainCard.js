...
import { ST_SLP_D_MainCardWrapper } from "./styles/ST_SLP_D_MainCardWrapper"

export const ST_SLP_D_MainCard = ({ thirdpageDataORG }) => {
  ...
  return (
    <ST_SLP_D_MainCardWrapper id="About">
      <div className="LEFT">
        <div>
          <Image
