...
import { MH_D_Results_CardsOnMapCard } from "./MH_D_Results_CardsOnMapCard.js"
import { MH_D_Results_CardsOnMapWrapper } from "./styles/MH_D_Results_CardsOnMapWrapper.js"

export const MH_D_Results_CardsOnMap = ({ bottomOfButton }) => {
  ...
  return (
    <MH_D_Results_CardsOnMapWrapper
      ref={myRef}
