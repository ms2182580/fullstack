...
import { MH_D_Results_FinalButtonsNumberPage_W } from "./styles/MH_D_Results_FinalButtonWrapper.js"

export const MH_D_Results_NavigationButtonsNumbers = () => {
      ...
      <div>
        {amountOfPagesToClick.map((x, i) => {
          ...
          if (pagination === i + 1) {
            return (
              <Fragment key={i}>
                <MH_D_Results_FinalButtonsNumberPage_W isActive>
                  <P bold> {i + 1}</P>
                </MH_D_Results_FinalButtonsNumberPage_W>
              </Fragment>
            )
          }
