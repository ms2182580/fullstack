...
import { ButtonLarge } from "../../../components/ui/buttons/general/index.js"
  ...
  return (
    <>
      <FirstSectionWrapper>
        <LeftData>
          <H1 bold cta>
            Your personal guide <br /> to the best services <br /> for your
            child
          </H1>
          <H3>
            Use our roadmaps to get providers your child <br /> needs through
          ...
          <Caption>
            ...
            <HyperlinkXS href="/" name="Finish your journey with us" />
          </Caption>
        </LeftData>
        <RightData>
          <SNT_FirstSection />
