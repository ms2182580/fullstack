...
const transformData = (item) => ({
    ...
    ratings: [
        { value: item['Rating Value 1'], description: item['Rating Description 1'] },
        { value: item['Rating Value 2'], description: item['Rating Description 2'] },
        { value: item['Rating Value 3'], description: item['Rating Description 3'] },
        { value: item['Rating Value 4'], description: item['Rating Description 4'] },
        { value: item['Rating Value 5'], description: item['Rating Description 5'] },
    ],
    faqs: [
