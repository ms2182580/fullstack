...
const INDEX_M_STSearch_Component = dynamic(() => import("../../components/ORG/pages/speech-therapists/first-page/mobile/INDEX_M_STSearch").then((mod) => mod.INDEX_M_STSearch), { ssr: false })
